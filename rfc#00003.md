...
assured if they are maintained.  Trust in the workload may decay or be
built up - the time context.  In this case, the workload does not have an
...
- host - the machine running workloads, including all hardware, firmware and software which is not specifically a workload
